#!/usr/bin/env python3
"""Validate the committed document regression contract and optional output bundle."""
import json
import sys
from pathlib import Path

root = Path(sys.argv[1] if len(sys.argv) > 1 else "tests/fixtures/document-regression")
