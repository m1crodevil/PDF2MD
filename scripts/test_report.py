...
with tempfile.TemporaryDirectory() as directory:
    ...
    manifest.write_text(json.dumps({"input":"fixture","output_dir":str(root),"ok":1,"skipped":0,"failed":0,"quality_failed":0,"review_required":0,"vlm_candidates":0,"pages_total":1,"pages_empty":0,"content_integrity":"complete"}))
