...
The fixture is intentionally not a full ground-truth transcription yet; it is a bounded integrity gate for page coverage, footer removal, and legal/financial token retention.
